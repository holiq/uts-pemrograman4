...
<div class="page-heading">
    ...
    <div class="card">
        <div class="card-body">
            <form method="post" action="<?= route_to('Anggota::store') ?>">
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="ttl_anggota" id="ttl_anggota" class="form-control">
                </div>

                <div class="mb-4">
                    <label for"alamat_anggota">Alamat Anggota</label>
                    <input type="text" name="alamat_anggota" id="alamat_anggota" class="form-control">
                </div>
